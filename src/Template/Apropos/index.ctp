...
<table border="1" cellpadding="5" cellspacing="0" width="40%" class="tabcenter">
   <tr align="center">
	  ...
	  <img src="DbHotel.png" alt="" width="700" height="500"  />
...
<table border="1" cellpadding="5" cellspacing="0" width="40%" class="tabcenter">
   <tr align="center">
      ...
      <tr> <td align="center" valign="top"><img src="BD.png" alt="" width="700" height="500"  /></td> </tr>

</table>
<h1 style="text-align:center;">Fonctionnement du site </h1>
<ol>
  <li>Enrgistrement d'utilisateur </li>
  <li>Menu avec infos sur l'utilisateur </li>
  <li>Traduction i18n en français et Allemagne</li>
  <li>Téléversement et affichage d'images liées aux hotels</li>
  <li>Envoi d'un courriel de confirmation avec UUID	</li>
  <li>Utlisation de Mysql pour la base de donnee</li>
</ol>
</body>
</html>
