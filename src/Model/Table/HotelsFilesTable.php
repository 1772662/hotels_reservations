 ...
 * @method \App\Model\Entity\HotelsFile|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\HotelsFile saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
